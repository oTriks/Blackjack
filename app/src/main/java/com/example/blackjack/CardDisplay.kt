...
class CardDisplay {
    val heartsImages = mapOf(
        Card.Rank.TWO to R.drawable.card_hearts_2, Card.Rank.THREE to R.drawable.card_hearts_3, Card.Rank.FOUR to R.drawable.card_hearts_4, Card.Rank.FIVE to R.drawable.card_hearts_5, Card.Rank.SIX to R.drawable.card_hearts_6, Card.Rank.SEVEN to R.drawable.card_hearts_7, Card.Rank.EIGHT to R.drawable.card_hearts_8, Card.Rank.NINE to R.drawable.card_hearts_9, Card.Rank.TEN to R.drawable.card_hearts_10, Card.Rank.JACK to R.drawable.card_hearts_j, Card.Rank.QUEEN to R.drawable.card_hearts_q, Card.Rank.KING to R.drawable.card_hearts_k, Card.Rank.ACE to R.drawable.card_hearts_a
    )
